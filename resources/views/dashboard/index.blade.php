    ...
    <div class="container-fluid">
        <div class="form-head d-flex mb-3 mb-md-4 align-items-start">
            <div class="mr-auto d-none d-lg-block">
                <h3 class="text-black font-w600">Welcome to HMS</h3>
                        ...
                        <div class="media align-items-center">
                            <div class="media-body">
                                ...
                                <div class="d-flex flex-wrap">
                                    <h2 class="fs-40 font-w600 text-white mb-0 mr-3">{{$patients->count()}}</h2>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="media align-items-center">
                            <div class="media-body">
                                ...
                                <div class="d-flex flex-wrap">
                                    <h2 class="fs-40 font-w600 text-white mb-0 mr-3">{{$doctors->count()}}</h2>
            ...
            <div class="col-xl-9 col-xxl-8 col-lg-7">
                <div class="card">
                    <div class="card-header border-0 pb-0">
                        ...
                        <a href="{{route('doctors.index')}}" class="text-primary font-w500">View more >></a>
                    </div>
                    <div class="card-body">
                        <div class="assigned-doctor owl-carousel">
                            ...
                            $formattedRating = $averageRating > 5 ? '5.0' : number_format($averageRating, 1);
                            @endphp

                            <div class="items">
                                <div class="text-center">
                                    <img src="{{ (($doctor->image != '') && file_exists(public_path('images/doctors/'.$doctor->image))) ? asset('images/doctors/'.$doctor->image) : asset('images/fallback-logo.png') }}" alt="">
                                    @if($formattedRating!=null)
                                    <div class="dr-star"><i class="las la-star"></i>{{ $formattedRating }}</div>
                                    @endif
                                    <h5 class="fs-16 mb-1 font-w600"><a class="text-black" href="page-review.html">Dr. {{$doctor->name}}.</a></h5>
                                    <span class="text-primary mb-2 d-block">{{$doctor->specialist}}</span>
                                    <p class="fs-12"> {{$doctor->address}} </p>                                    
                                </div>
                            </div>
                            @endforeach
                        </div>
            ...
            <div class="col-xl-3 col-xxl-4 col-lg-5">
                <div class="card border-0 pb-0">
                    <div class="card-header flex-wrap border-0 pb-0">
                        ...
                        <a href="{{route('patients.index')}}" class="text-primary font-w500">View more >></a>
                    </div>
                    <div class="card-body">
                                    ...
                                    <li>
                                        <div class="timeline-panel flex-wrap">
                                            <div class="media mr-3">
                                                <img class="rounded-circle" alt="image" width="50" src="{{ (($patient->image != '') && file_exists(public_path('images/patients/'.$patient->image))) ? asset('images/patients/'.$patient->image) : asset('backend/images/logo.png') }}">
                                            </div>
                                            <div class="media-body">
                                                <h5 class="mb-1"><a class="text-black" href="{{route('patients.show',$patient->id)}}">{{$patient->name}}</a></h5>
                                                <span class="fs-14">{{$patient->patient_id}}</span>
                                            </div>
                                            @if($patient->status==1)
                                            <a href="{{route('patients.show',$patient->id)}}" class="text-info mt-2">New Patient</a>
                                            @elseif($patient->status==2)
                                            <a href="{{route('patients.show',$patient->id)}}" class="text-success mt-2">Recovered</a>
                                            @elseif($patient->status==3)
                                            <a href="{{route('patients.show',$patient->id)}}" class="text-warning mt-2">On Recovery</a>
                                            @else
                                            <a href="{{route('patients.show',$patient->id)}}" class="text-danger mt-2">Critical</a>
                                            @endif
