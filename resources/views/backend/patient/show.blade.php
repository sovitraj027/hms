    ...
    <div class="container-fluid">
        ...
        <div class="d-md-flex d-block mb-3 align-items-center">
            ...
            {{-- <div class="dropdown d-inline-block ml-auto mr-2">
                <button type="button" class="btn btn-outline-primary btn-rounded dropdown-toggle font-w600"
            ...
            <a href="{{route('patients.edit',$patient->id)}}" class="btn btn-primary btn-rounded wspace-no"><i
                    class="las scale5 la-pencil-alt mr-2"></i> Edit</a>
        </div>
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="media d-sm-flex d-block text-center text-sm-left pb-4 mb-4 border-bottom">
                            <img alt="image" class="rounded mr-sm-4 mr-0" width="130" src="{{ asset('backend/images/logo.png') }}">
                            <div class="media-body align-items-center">
                                <div class="d-sm-flex d-block justify-content-between my-3 my-sm-0">
                                    <div>
                                        <h3 class="fs-22 text-black font-w600 mb-0">{{$patient->name}}</h3>
                                        <p class="mb-2 mb-sm-2">Checked In {{\Carbon\Carbon::parse($patient->check_in_date)->format('l d F Y')}}</p>
                                    </div>
                                    <span>#{{$patient->patient_id}}</span>
                                </div>
                                <a href="javascript:void(0);" class="btn bgl-primary btn-rounded text-black mb-2 mr-2">
                                    <svg class="mr-2 scale5" width="14" height="14" viewBox="0 0 26 26" fill="none"
                                ...
                                <a href="javascript:void(0);" class="btn bgl-primary btn-rounded mb-2 text-black">
                                    <svg class="mr-2 scale5" width="14" height="14" viewBox="0 0 28 28" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="fs-18 text-dark">
                                            <strong>{{$patient->address}}</strong></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 mb-md-0 mb-3">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="fs-18 text-dark font-w600 mb-0"></p>+977 {{$patient->contact}}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="media">
                                    ...
                                    @if(isset($patient->email)!=null)
                                    <div class="media-body">
                                        <span class="d-block text-light mb-2">Email</span>
                                        <p class="fs-18 text-dark font-w600 mb-0">{{$patient->email}}</p>
                                    </div>
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="widget-timeline-icon2">
                            <ul class="timeline">
                                ...
                                <li>
                                    ...
                                    <a class="timeline-panel text-muted" href="javascript:void(0);">
                                        <h4 class="mb-2 mt-1">{{$history->history_title}}</h4>
                                        <p class="fs-15 mb-0 ">{{\Carbon\Carbon::parse($history->history_date)->format('l d F Y - H:i')}}</p>
                                    </a>
                                </li>
                                @endforeach
                            </ul>
            ...
            <div class="col-xl-3 col-xxl-12 col-md-6">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        <div class="mt-4">
                            <p class="mb-2 d-flex text-dark font-w500  fs-14">Sugar ({{$patient->sugar}}%)
                                <span class="pull-right ml-auto">{{$patient->sugar}}</span>
                            </p>
                            <div class="progress mb-3" style="height:8px">
                                <div class="progress-bar bg-secondary progress-animated" style="width:{{$patient->sugar}}%; height:8px;"
                                    role="progressbar">
                                    {{-- <span class="sr-only">60% Complete</span> --}}
                                </div>
                            </div>
                            <p class="mb-2 d-flex text-dark font-w500  fs-14">Heart Beat ({{$patient->heart_rate}}%)
                                <span class="pull-right ml-auto">{{$patient->heart_rate}}</span>
                            </p>
                            <div class="progress mb-3" style="height:8px">
                                <div class="progress-bar bg-warning progress-animated" style="width:{{$patient->heart_rate}}%; height:8px;"
                                    role="progressbar">
                                    {{-- <span class="sr-only">60% Complete</span> --}}
                                </div>
                            </div>
                            <p class="mb-2 d-flex  text-dark font-w500 fs-14">Oxygen Level ({{$patient->oxygen_level}}%)
                                <span class="pull-right ml-auto">{{$patient->oxygen_level}}</span>
                            </p>
                            <div class="progress" style="height:8px">
                                <div class="progress-bar bg-success progress-animated" style="width:{{$patient->oxygen_level}}%; height:8px;"
                                    role="progressbar">
                                    {{-- <span class="sr-only">60% Complete</span> --}}
                                </div>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="media d-sm-flex text-sm-left d-block text-center">
                            ...
                            <img alt="{{$patient->doctor->name}}" class="rounded mr-sm-4 mr-0 mb-2 mb-sm-0" width="130"
                                src="{{ (($patient->doctor->image != '') && file_exists(public_path('images/doctors/'.$patient->doctor->image))) ?
                                asset('images/doctors/'.$patient->doctor->image) : asset('backend/images/logo.png') }}">
                            <div class="media-body">
                                <h3 class="fs-22 text-black font-w600">Dr. {{$patient->doctor->name}}</h3>
                                <p class="text-primary">{{$patient->doctor->specialist}}</p>
