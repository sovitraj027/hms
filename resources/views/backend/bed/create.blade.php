    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <h2 class="lead text-center">Create a Bed</h2>
            </div>
            <div class="card-body">
                ...
                <form action="{{route('bed.store')}}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <input type="text" class="form-control" name="bed_no" id="email" value="{{ old('bed_no') }}"
                    ...
                    <div class="row">
                        <div class="form-group col-lg-6">
                            ...
                            <input type="number" class="form-control" id="" name="price" autocomplete="off">
